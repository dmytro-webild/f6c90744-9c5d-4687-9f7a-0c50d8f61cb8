...
export default function LandingPage() {
  ...
  <div id="nav" data-section="nav">
      ...
      button={{
        text: "Get Organized",        href: "#contact"}}
    />
  </div>
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",          title: "What areas do you organize?",          content: "We organize all areas of your home, including kitchens, pantries, closets, bedrooms, bathrooms, home offices, playrooms, garages, and more. We also assist with downsizing and relocation."},
        {
          id: "q2",          title: "How long does a session take?",          content: "Session lengths vary based on the scope of the project. We offer hourly rates (minimum 3 hours), half-day (4-hour) packages, and full-day (8-hour) immersion sessions. A consultation helps us determine the best fit for you."},
        {
          id: "q3",          title: "Do I need to be present during the organizing process?",          content: "While your input is valuable, especially during the decluttering and decision-making phases, you don't need to be present for every moment. We can work independently once a plan is established, but we encourage active participation for the best results."},
        {
          id: "q4",          title: "What about confidentiality?",          content: "Client confidentiality is paramount. We treat all client information and home details with the utmost respect and privacy. Your trust is our top priority."},
        {
          id: "q5",          title: "Do you handle donations and recycling?",          content: "Yes, as part of our service, we can assist with taking donations to local charities or arranging for recycling of items that no longer serve you."},
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Schedule a Consultation",          href: "mailto:info@organizedhabitat.com"},
        {
      ...
      columns={[
        {
          title: "Services",          items: [
            {
              label: "Kitchen & Pantry",              href: "#services"},
            {
              label: "Closet & Wardrobe",              href: "#services"},
            {
              label: "Home Office",              href: "#services"},
            {
              label: "Full Home Organization",              href: "#packages"},
          ],
        },
        {
          title: "Company",          items: [
        ...
        },
        {
          title: "Connect",          items: [
            {
              label: "Email: info@organizedhabitat.com",              href: "mailto:info@organizedhabitat.com"},
            {
              label: "Phone: +1 (555) 123-4567",              href: "tel:+15551234567"},
            {
              label: "Facebook",              href: "https://www.facebook.com/organizedhabitat"},
            {
              label: "Instagram",              href: "https://www.instagram.com/organizedhabitat"},
            {
              label: "LinkedIn",              href: "https://www.linkedin.com/company/organizedhabitat"},
          ],
        },
      ]}
